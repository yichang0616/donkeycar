...
if __name__ == '__main__':
    ...
    while(interval< 5):
        ...
        ominibot.individual_wheel(V1=50, debug=True)
        time.sleep(0.5)
        ominibot.individual_wheel(V2=50, debug=True)
        time.sleep(0.5)
        ominibot.individual_wheel(V3=50, debug=True)
        time.sleep(0.5)
        ominibot.individual_wheel(V4=50, debug=True)
        time.sleep(0.5)
